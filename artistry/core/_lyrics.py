...
def find_lyrics(artistName):
    page = requests.get(__getURL(artistName))
...
def __getURL(artistName):
    ...
    y = json.loads(r.text)
    return y['response']['hits'][0]['result']['url']


if __name__ == '__main__':
    print(find_lyrics("Eminem"))
